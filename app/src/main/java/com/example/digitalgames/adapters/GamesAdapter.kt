package com.example.digitalgames.adapters
...
class GamesAdapter(private val listGames: ArrayList<Game>, val listener: OnGameClickListener): RecyclerView.Adapter<GamesAdapter.FilmesViewHolder>(),
    Filterable {
    ...
    var listGamesFilter = arrayListOf<Game>()
    ...
    override fun getFilter(): Filter {
        return object : Filter() {
            ...
            override fun publishResults(constraint: CharSequence?, results: FilterResults?) {
                listGamesFilter = results?.values as ArrayList<Game>
