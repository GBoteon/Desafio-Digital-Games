...
import com.example.digitalgames.helper.Constants.EMPTY_STRING
import com.example.digitalgames.helper.Constants.KEY_EMAIL
import com.example.digitalgames.helper.Constants.PREFS_NAME
import com.example.digitalgames.R
import com.example.digitalgames.viewmodels.GamesViewModel
import com.squareup.picasso.Picasso
import dmax.dialog.SpotsDialog
import kotlinx.android.synthetic.main.activity_add_game.*
import com.example.digitalgames.classes.Game as Game
...
class AddGameActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var gameClick = intent.getSerializableExtra("gameClick") as Game
        ...
        Button_AddGame_SaveGame.setOnClickListener {
            if(validateFildsGame(
                ...
                Toast.makeText(this, "Informe os dados para cadastro do game.", Toast.LENGTH_SHORT).show()
            }
        }
    ...
    private fun initViewModel() {
        viewModel.stateAddGame.observe(this) {
            if(it) {
                ...
                Toast.makeText(this, "Falha ao cadastro do game.", Toast.LENGTH_SHORT).show()
            }
        }
        viewModel.stateDelGame.observe(this) {
            if(it) {
                Toast.makeText(this, "Game deletado com exito!", Toast.LENGTH_SHORT).show()
                startActivity(Intent(this, GamesActivity::class.java))
            } else {
                Toast.makeText(this, "Falha ao deletar o game.", Toast.LENGTH_SHORT).show()
            }
        }
